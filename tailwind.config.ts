  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-gold": { "0%, 100%": { boxShadow: "0 0 0 0 hsl(42 52% 50% / 0.4)" }, "50%": { boxShadow: "0 0 0 8px hsl(42 52% 50% / 0)" } },
        "chat-bounce": { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-4px)" } },
      },
      animation: {
        ...
        "chat-bounce": "chat-bounce 1.5s ease-in-out infinite",
      },
    },
  },
